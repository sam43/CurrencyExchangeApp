...
//    val zWL: Double? = 0.0
    ...
    fun toRateInfo(): Rates {
        return Rates(
            ...
            cDF, cHF, cLF, cLP, cNH, cNY, cOP, cRC, cUP, cVE, cZK, dJF, dKK, dOP, dZD, eGP, eRN, eTB, eUR, fJD, fKP, gBP, gEL, gGP, gHS, gIP, gMD, gNF, gTQ, gYD, hKD, hNL, hRK, hTG, hUF, iLS, iMP, iNR, iQD, iSK, jEP, jMD, jOD, jPY, kES, kGS, kHR, kMF, kRW, kWD, kYD, kZT, lAK, lBP, lKR, lRD, lSL, lYD, mAD, mDL,
            mGA, mKD, mMK, mNT, mOP, mRU, mUR, mVR, mWK, mXN, mYR, mZN, nAD, nGN, nIO, nOK, nPR, nZD, oMR, pEN, pGK, pHP, pKR?.toDouble(), pLN, pYG, qAR, rON, rSD, rUB, rWF, sAR, sBD, sCR, sDG, sEK, sGD, sHP, sLL, sOS, sRD, sSP, sTD, sTN, sVC, sYP, sZL, tHB, tJS, tMT, tND, tOP, tRY, tTD, tWD, uAH, uGX, uSD, uYU, uZS, vES, vUV, wST, xAF, xAG, xAU, xCD, xDR, xOF, xPD, xPF, xPT, yER, zAR, zMW
        )
    }
}